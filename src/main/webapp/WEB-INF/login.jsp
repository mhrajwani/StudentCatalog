...
<body>
	...
	<div class="container">
		<form action="loginServlet" method="post">
			<label for="uname">Professor Login</label> <input type="text"
				id="professorname" name="pn" placeholder="type professor name...">
			<input type="password" id="password" name="password"
				placeholder="type password..."> <input type="submit"
				value="Submit">
			<button class="button1">
				<a href="addProfessor">Add New Professor</a>
			</button>
		</form>
	</div>
</body>
